...
[SYMB] = LAYOUT_ergodox_pretty(
  ...
  _______, KC_EXLM,   KC_AT,   _______, KC_TAB,   LSFT(KC_TAB), _______,                   _______, ST_DBL_BQ,KC_TILD, KC_DQUO,  KC_PIPE,  KC_BSLS, _______,
  _______, KC_HASH,   KC_DLR,  _______, KC_ESC,   LSFT(KC_ESC),                                     KC_PLUS,  KC_MINS, KC_SLASH, KC_ASTR,  KC_QUOT, _______,
  _______, KC_PERC,   KC_CIRC, _______, KC_COLN,  _______,      _______,                   _______, KC_AMPR,  KC_EQUAL,KC_COMMA, KC_DOT,   KC_SCLN,_______,
...
[PAREN] = LAYOUT_ergodox_pretty(
  ...
  _______,KC_HOME,KC_END,ST_KAK_SAV, _______,_______,_______,                 _______, _______,      KC_LCBR,KC_RCBR,_______,       _______,_______,
  _______,KC_LABK,KC_RABK,KC_BSPC,   _______,_______,                                  LALT(KC_LEFT),KC_LPRN,KC_RPRN,LALT(KC_RIGHT),_______,_______,
  _______,KC_PGUP,KC_PGDN,_______,   _______,_______,_______,                 _______, _______,      KC_LBRC,KC_RBRC,_______,       _______,_______,
  _______,_______,_______,_______,   _______,                                                        _______,_______,_______,       _______,_______,
                                                   _______,_______, _______,_______,
                                                           _______, _______,
...
[NUMPAD] = LAYOUT_ergodox_pretty(
  ...
  _______, KC_F1,  KC_F2,    KC_F3,  KC_F4,   KC_F5,                                        KC_LEFT, KC_DOWN,KC_UP,  KC_RIGHT,KC_F10,  _______,
  _______, KC_F6,  KC_F7,    KC_F8,  KC_F9,   _______, _______,                    _______, KC_F11,  KC_F12, KC_F13, KC_F14,  KC_F15,   _______,
  _______, _______,_______,  _______,_______,                                                        _______,_______,_______, _______, _______,
