...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [0] = LAYOUT_ergodox_pretty(
    ...
    OSM(MOD_RSFT),  LCTL_T(KC_Z),   KC_X,           LT(1,KC_C),     KC_V,           LT(3,KC_B),     KC_GRAVE,                                       KC_BSLASH,      LT(5,KC_N),     KC_M,           KC_COMMA,       KC_DOT,         KC_SLASH,          OSM(MOD_RSFT),
  ...
  [1] = LAYOUT_ergodox_pretty(
    ...
    KC_TRANSPARENT, KC_TRANSPARENT, KC_LPRN,        KC_TRANSPARENT, KC_TAB,         KC_LPRN,        KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_RPRN,        KC_PLUS,        KC_PIPE,        KC_QUOTE,       KC_TRANSPARENT, KC_TRANSPARENT,
    KC_TRANSPARENT, ST_KAK_SAV,     KC_LCBR,        KC_TRANSPARENT, KC_ESC,         KC_LCBR,                                                                        KC_RCBR,        KC_EQUAL,       KC_BSLASH,      KC_DQUO,        KC_COLN,        KC_TRANSPARENT,
    KC_TRANSPARENT, KC_TRANSPARENT, KC_LBRC,        KC_TRANSPARENT, LSFT(KC_TAB),   KC_LABK,        KC_LABK,                                        KC_RABK,        KC_RBRC,        KC_TRANSPARENT, KC_TRANSPARENT, ST_DBL_BQ,      KC_TRANSPARENT, KC_TRANSPARENT,
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_LSHIFT,                                                                                                      KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
